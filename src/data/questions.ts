...
function generateScalesIxQuestions(): Question[] {
  ...
  const patterns = [
    ...
    {
      allShapes: ['diamond', 'cross', 'star', 'diamond', 'cross', 'star', 'diamond', 'cross', 'cross'],
      oddOneOut: 'cross',
      oddOneOutIndex: 8,
      difficulty: 4,
      explanation: '模式是菱形、十字、星形重复。第9个应该是星形，但却是十字。',
    },
    {
      allShapes: ['hexagon', 'hexagon', 'triangle', 'hexagon', 'hexagon', 'triangle', 'hexagon', 'hexagon', 'hexagon'],
      oddOneOut: 'hexagon',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是两个六边形、一个三角形重复。第9个应该是三角形，但却是六边形。',
    },
    {
      allShapes: ['circle', 'circle', 'circle', 'triangle', 'triangle', 'triangle', 'circle', 'circle', 'triangle'],
      oddOneOut: 'triangle',
      oddOneOutIndex: 8,
      difficulty: 4,
      explanation: '模式是三个圆形、三个三角形、三个圆形重复。第9个应该是圆形，但却是三角形。',
    },
    {
      allShapes: ['star', 'square', 'diamond', 'star', 'square', 'diamond', 'star', 'square', 'square'],
      oddOneOut: 'square',
      oddOneOutIndex: 8,
      difficulty: 4,
      explanation: '模式是星形、正方形、菱形重复。第9个应该是菱形，但却是正方形。',
    },
    {
    ...
    {
      allShapes: ['triangle', 'circle', 'triangle', 'circle', 'triangle', 'circle', 'triangle', 'circle', 'circle'],
      oddOneOut: 'circle',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是三角形和圆形交替。第9个应该是三角形，但却是圆形。',
    },
    {
      allShapes: ['square', 'hexagon', 'square', 'hexagon', 'square', 'hexagon', 'square', 'hexagon', 'hexagon'],
      oddOneOut: 'hexagon',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是正方形和六边形交替。第9个应该是正方形，但却是六边形。',
    },
    {
      allShapes: ['diamond', 'diamond', 'cross', 'diamond', 'diamond', 'cross', 'diamond', 'diamond', 'diamond'],
      oddOneOut: 'diamond',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是两个菱形、一个十字重复。第9个应该是十字，但却是菱形。',
    },
    {
      allShapes: ['star', 'star', 'star', 'circle', 'circle', 'circle', 'star', 'star', 'circle'],
      oddOneOut: 'circle',
      oddOneOutIndex: 8,
      difficulty: 4,
      explanation: '模式是三个星形、三个圆形、三个星形重复。第9个应该是星形，但却是圆形。',
    },
    {
      allShapes: ['triangle', 'square', 'hexagon', 'triangle', 'square', 'hexagon', 'triangle', 'square', 'square'],
      oddOneOut: 'square',
      oddOneOutIndex: 8,
      difficulty: 4,
      explanation: '模式是三角形、正方形、六边形重复。第9个应该是六边形，但却是正方形。',
    },
    {
      allShapes: ['cross', 'diamond', 'cross', 'diamond', 'cross', 'diamond', 'cross', 'diamond', 'diamond'],
      oddOneOut: 'diamond',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是十字和菱形交替。第9个应该是十字，但却是菱形。',
    },
    {
      allShapes: ['circle', 'star', 'circle', 'star', 'circle', 'star', 'circle', 'star', 'star'],
      oddOneOut: 'star',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是圆形和星形交替。第9个应该是圆形，但却是星形。',
    },
    {
      allShapes: ['hexagon', 'triangle', 'hexagon', 'triangle', 'hexagon', 'triangle', 'hexagon', 'triangle', 'triangle'],
      oddOneOut: 'triangle',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是六边形和三角形交替。第9个应该是六边形，但却是三角形。',
    },
    {
      allShapes: ['square', 'cross', 'square', 'cross', 'square', 'cross', 'square', 'cross', 'cross'],
      oddOneOut: 'cross',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是正方形和十字交替。第9个应该是正方形，但却是十字。',
    },
    {
      allShapes: ['diamond', 'star', 'diamond', 'star', 'diamond', 'star', 'diamond', 'star', 'star'],
      oddOneOut: 'star',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是菱形和星形交替。第9个应该是菱形，但却是星形。',
    },
    {
      allShapes: ['triangle', 'cross', 'triangle', 'cross', 'triangle', 'cross', 'triangle', 'cross', 'cross'],
      oddOneOut: 'cross',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是三角形和十字交替。第9个应该是三角形，但却是十字。',
    },
    {
      allShapes: ['circle', 'square', 'circle', 'square', 'circle', 'square', 'circle', 'square', 'square'],
      oddOneOut: 'square',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是圆形和正方形交替。第9个应该是圆形，但却是正方形。',
    },
    {
      allShapes: ['star', 'hexagon', 'star', 'hexagon', 'star', 'hexagon', 'star', 'hexagon', 'hexagon'],
      oddOneOut: 'hexagon',
      oddOneOutIndex: 8,
      difficulty: 3,
      explanation: '模式是星形和六边形交替。第9个应该是星形，但却是六边形。',
    },
  ];
